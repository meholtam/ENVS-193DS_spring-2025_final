...
model1 <- ggpredict(model1, terms = c("edge_distance, [0:1100 by=10]", "season"))
ggplot(nest_boxes_clean, # creates base ggplot object using clean data
  ...
  geom_ribbon(data = model1, # adds confidence ribbon using model prediction data 
              aes(x = x, 
  ...
  geom_line(data = model1, # adds prediction line
            aes(x = x,
                y = predicted),
